...
class WikiPage implements Page, IDBAccessObject {
	...
	private function doModify(
		...
		// Initial Point class to get default number of point when editing a page
		$point  = new Point(0);
		
		$revision = new Revision( [
			'page'       => $this->getId(),
			'points_generated'       => $point->getPointsGenerated(), // for returning the default number of point when editing a page
	...
	private function doCreate(
		...
		// @TODO: pass content object?!
		// // Initial Point class to get default number of point when adding a page
		$point  = new Point(1);
		$revision = new Revision( [
			'page'       => $newid,
			'points_generated'       => $point->getPointsGenerated(), // for returning the default number of point when adding a page
			'title'      => $this->mTitle, // for determining the default content model
			'comment'    => $summary,
			'minor_edit' => $meta['minor'],
			'text'       => $meta['serialized'],
