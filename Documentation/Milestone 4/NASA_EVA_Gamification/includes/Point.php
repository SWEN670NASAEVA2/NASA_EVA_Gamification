...
class Point implements IDBAccessObject {
	...
	public function setPointsGenerated( $points_generated ) {
		global $wgPoints;
		if (!in_array($points_generated, $wgPoints)) {
	 ...
	 * @return Revision|null
	 */
	public function getTotalPointsFromUserId( $id ) {
		if (is_null($id) || $id <=0) {
			return "Invalid Value";
		}
	 ...
	 * @return Revision|null
	 */
	public function getAddedPostFromUserId( $id ) {
		global $wgPoints;
	 ...
	 * @return Revision|null
	 */
	public function getEditedPostFromUserId( $id ) {
		global $wgPoints;
