...
class Revision implements IDBAccessObject {
	...
	function __construct( $row ) {
		if ( is_object( $row ) ) {
			...
			$this->mPointsGenerated = intval( $row->rev_points_generated );
			...
			$this->mPointsGenerated = isset( $row['points_generated'] ) ? intval( $row['points_generated'] ) : null;
	...
	public function insertOn( $dbw ) {
		...
		$row = [
			'rev_id'         => $rev_id,
			'rev_page'       => $this->mPage,
			'rev_points_generated'       => $this->mPointsGenerated,
